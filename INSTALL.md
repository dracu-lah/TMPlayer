...
already there — `adb uninstall com.tmplayer` first.
...
| **Left / Right** (controls showing) | Scrub the progress bar — press **OK** to jump there |
...
`TG_API_HASH`. See [README](README.md#building).
